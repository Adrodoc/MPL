...
public class MplBreak extends ModifiableChainPart {
  ...
  public MplBreak(String label) {
    this(label, new ModifierBuffer());
  }

  public MplBreak(String label, ModifierBuffer modifier) {
    super(modifier);
    this.label = label;
  }

  @GenerateMplPojoBuilder
  public MplBreak(String label, ModifierBuffer modifier, @Nullable Dependable previous) {
