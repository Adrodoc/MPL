...
public class StringUnescaper {
   ...
   *
   * It's completely ridiculous that there's no standard unescape_java_string function. Since I have
   * to do the damn thing myself, I might as well make it halfway useful by supporting things Java
   * was too stupid to consider in strings:
   *
   ...
   *
   * NB: \b is unsupported as backspace so it can pass-through to the regex translator untouched; I
   * refuse to make anyone doublebackslash it as doublebackslashing is a Java idiocy I desperately
   * wish would die out. There are plenty of other ways to write it:
   *
   ...
   *
   * Perl hex escapes: !\x{XXX} braced may be 1-8 xdigits NB: proper Unicode never needs more than
   * 6, as highest valid codepoint is 0x10FFFF, not maxint 0xFFFFFFFF
   *
   * Lame Java escape: \[IDIOT JAVA PREPROCESSOR]uXXXX must be exactly 4 xdigits;
   *
   * I can't write XXXX in this comment where it belongs because the damned Java Preprocessor can't
   * mind its own business. Idiots!
   *
   * Lame Python escape: !\UXXXXXXXX must be exactly 8 xdigits
   *
   * TODO: Perl translation escapes: \Q \U \L \E \[IDIOT JAVA PREPROCESSOR]u \l These are not so
