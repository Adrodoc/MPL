...
public class MplStop extends PossiblyConditionalChainPart implements ModeOwner {
  ...
  public MplStop(String process, @Nullable Conditional conditional) {
    super(conditional);
    this.process = checkNotNull(process, "process == null!");
  }

  public MplStop(String process, @Nullable Conditional conditional, @Nullable ModeOwner previous) {
