 ...
 * @author Adrodoc55
 */
public class NewDoWhileAction extends AutoCompletionAction {

  public NewDoWhileAction(int startIndex, Token token) {
  ...
  protected String getTemplate() {
    return getUtf8String(getResource("autocompletion/do-while.template"));
  }
  ...
  public boolean shouldBeProposed(AutoCompletionContext context) {
    ...
    return "do".startsWith(token.getText());
  }
}
