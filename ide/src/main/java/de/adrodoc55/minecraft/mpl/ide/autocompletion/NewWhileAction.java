 ...
 * @author Adrodoc55
 */
public class NewWhileAction extends AutoCompletionAction {

  public NewWhileAction(int startIndex, Token token) {
  ...
  protected String getTemplate() {
    return getUtf8String(getResource("autocompletion/while.template"));
  }
  ...
  public boolean shouldBeProposed(AutoCompletionContext context) {
    ...
    return "while".startsWith(token.getText());
  }
}
