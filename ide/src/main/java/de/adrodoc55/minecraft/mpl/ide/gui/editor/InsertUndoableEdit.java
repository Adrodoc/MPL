 ...
 * @author Adrodoc55
 */
public class InsertUndoableEdit extends AbstractUndoableBnEdit {
  ...
  public boolean canUndo() {
    return super.canUndo() && offset + text.length() <= doc.getLength();
  }
  ...
  public boolean canRedo() {
    return super.canRedo() && offset <= doc.getLength();
  }
